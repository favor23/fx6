...
public class Hash {	
	...
	public String hashtest(MemberDTO memberDTO) throws Exception {
		byte defaultPlainText[] = { (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04, (byte) 0x05,
		...
		String plainTextStr = memberDTO.getPw();
