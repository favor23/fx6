							...
							<td>
								<table class="tab">
									<tr>
										<td>이름</td>
										<td>
											<input type="text" name="register_name" class="register_name" readonly="readonly" value="${member.name}" style="width: 100%; height: 40px; border-radius: 4px; border: 1px solid #b8b894; margin-right: 10px; margin-top: 10px;">
										</td>
									</tr>
									<tr>
										<td>전화번호</td>
										<td>
											<input type="text" name="register_phone" class="register_phone" placeholder="'-'를 제외한 나머지 번호를 입력해주세요." value="${member.phone}" style="width: 100%; height: 40px; border-radius: 4px; border: 1px solid #b8b894; margin-right: 10px; margin-top: 10px;">
										</td>
									</tr>
									<tr>
										<td>E-mail</td>
										<td>
											<input type="email" name="register_email" class="register_email" placeholder="ex. honggildong@gmail.com" value="${member.email}" style="width: 100%; height: 40px; border-radius: 4px; border: 1px solid #b8b894; margin-right: 10px; margin-top: 10px;">
										</td>
									</tr>
								</table>
							...
							<td>
								...
								<table class="tab">
									...
									<tr>
										<td>계좌번호</td>
										<td>
											<input type="text" name="bank_account" class="bank_account" placeholder="'-'를 제외한 나머지 번호를 입력해주세요." style="width: 100%; height: 40px; border-radius: 4px; border: 1px solid #b8b894; margin-right: 10px; margin-top: 10px;">
										</td>
									</tr>
								</table>
